...
A Rust-based monorepo for rocket trajectory simulation combining JSBSim integration with custom simulation engines, providing CLI and Tauri GUI interfaces.
